...
public class MyReaderActivity  extends Activity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_reader);
        final ImageView exit_myreader=(ImageView)findViewById(R.id.exit_myreader);
        exit_myreader.setOnClickListener(
...
//		viewPager.setOffscreenPageLimit(1);// 左右各保留几个对象
    ...
    private void initData() {
        // 图片资源id数组
        imageResIds = new int[]{R.drawable.my_reader_a, R.drawable.my_reader_b, R.drawable.my_reader_c, R.drawable.my_reader_d, R.drawable.my_reader_e};
        ...
        for (int i = 0; i < imageResIds.length; i++) {
            ...
            pointView.setBackgroundResource(R.drawable.ll_point_container);
